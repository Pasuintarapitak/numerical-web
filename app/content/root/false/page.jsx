...
export default function False_poistion() {
    ...
    const Calfalse = () => {
        ...
        while (iter < MAX) {
            xm = ( (findx(equation,xr)*xl )- (findx(equation,xl)*xr ))/ (findx(equation,xr) - findx(equation,xl));
    ...
    return (
        <div>
            <div className='mt-8 text-center text-4xl header'>False Position Method</div>
